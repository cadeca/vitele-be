...
class UptUserTypeSelectorTest {
    ...
    fun `test user with roles student and teacher`() {
        ...
        assertEquals(ro.cadeca.weasylearn.persistence.user.STUDENT, uptUserTypeSelector.selectType(kcUser))
    }
    ...
    fun `test user with roles teacher`() {
        ...
        assertEquals(ro.cadeca.weasylearn.persistence.user.TEACHER, uptUserTypeSelector.selectType(kcUser))
    }
